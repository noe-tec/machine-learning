"""RFE -- finding the optimal number of features.

Repeats cross-validated RFE for every possible number of features (1
through 9), plots MSE/MAE/R^2 against the number of features, and refits the
final model using the number of features that minimizes MSE.
"""
import numpy as np
