# machine-learning
This repository contains code examples, activities and external links related with machine learning.

## Demos
|ID | Open in Colab | Description |
|---|---|---|
| 1 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/demos/demo_interactive_linear_regression.ipynb) | Interactive visualization of a linear model fit to house prices. |
...
| 3 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/demos/Diffusion_Model_Toy_Example.ipynb) | Diffusion Model Toy Example |
-->

## Examples
Standalone, single-purpose Python scripts (no notebook boilerplate) demonstrating individual evaluation and feature-selection techniques. See [`examples/README.md`](examples/README.md) for the full index.

## Activities
|ID | Open in Colab | Description |
|---|---|---|
| 1 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/activity_gradient_descent_implementation.ipynb) | Gradient descent implementation |
| 2 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/activity_learning_and_validation_curves.ipynb) | Learning and validation curves - Regression Models |
| 3 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/activity_svm_moons.ipynb) | SVM with Moons dataset |
| 4 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/activity_grow_a_forest.ipynb) | Grow a forest |
| 5 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/actividad_desvanecimiento_gradiente.ipynb) | Actividad desvanecimiento del gradiente - Spanish! |
| 6 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/actividad_entrenando_una_red_neuronal_desde_cero.ipynb) | Entrenando una red neuronal desde cero con retropropagación y descenso de gradiente - Spanish! |
| 7 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/actividad_estructuracion_de_un_modelo_de_aprendizaje_profundo.ipynb) | Estructuración de un modelo de aprendizaje profundo - Spanish! |
| 8 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/actividad_feature_selection_part1_manual.ipynb) | Selección de features a mano - Parte 1 - Spanish! |
| 9 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/actividad_feature_selection_part2_automatic.ipynb) | Selección de features - métodos automáticos - Parte 2 - Spanish! |
| 10 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/activity_perceptron_multicapa_en_accion.ipynb) | El perceptrón multicapa en acción |
| 11 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noe-tec/machine-learning/blob/main/activities/actividad_gradient_descent_escalas.ipynb) | Descenso de gradiente: el impacto de escalar las variables - Spanish! |
...
| 3 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/aimacode/aima-python/blob/master/knowledge_version_space.ipynb#scrollTo=EKgDrTAnDwBj) | Version Space | AIMA code repository |


## Books / Tutorials
|ID | Description | Author |
|---|---|---|
| 1 | [PythonDataScienceHandbook](https://github.com/jakevdp/PythonDataScienceHandbook) | Jake VanderPlas |
